                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                <a href="{{ route('induk_organisasi.create') }}" class="btn btn-info btn-icon btn-sm mr-1 mb-1"><i class="ft-plus"></i></a>
                                                ...
                                                @foreach($datas as $key => $data)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button type="button" class="btn btn-icon btn-danger btn-sm delete" data-id="{{$data->id}}"><i class="ft-delete"></i></button>
