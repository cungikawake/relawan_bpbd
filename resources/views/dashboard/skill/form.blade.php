          ...
          <div class="content-header-right col-md-8 col-12">
            <div class="breadcrumbs-top float-md-right">
              <div class="breadcrumb-wrapper mr-1">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="{{ route('dashboard.skill.index') }}">Dashboard</a></li>
                                ...
                                <div class="card-block">
                                    <div class="card-body">
                                        ...
                                        <fieldset class="form-group">
                                            <input type="text" class="form-control" name="nama" value="{{old('nama', $model->nama_skill)}}" placeholder="Nama">
                                        </fieldset>
                                        
                                        <h5 class="mt-2">Prioritas <span class="danger">*</span></h5>
                                        <fieldset class="form-group">
                                            <input type="text" class="form-control" name="prioritas" value="{{old('prioritas', $model->prioritas_skill)}}" placeholder="Prioritas">
                                        </fieldset>
                                    </div>
